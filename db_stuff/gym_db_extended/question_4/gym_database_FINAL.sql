...
--
-- Host: localhost
-- Generation Time: Jun 10, 2026 at 03:50 PM
...
(1, 'Yoga', 'Πρωινή χαλάρωση και ευεξία', 15, 60, 10, 1, 4, 7519, '15/06/2026 09:00', 5),
(2, 'CrossFit', 'Έντονη διαλειμματική προπόνηση', 10, 45, 15, 1, 3, 7517, '15/06/2026 18:00', 8),
(3, 'Pilates', 'Ενδυνάμωση κορμού', 12, 50, 12, 0, 2, 7516, '16/06/2026 10:00', 12),
(4, 'Weightlifting', 'Ολυμπιακή άρση βαρών', 8, 90, 20, 1, 1, 7515, '16/06/2026 17:00', 4),
(5, 'Bodybuilding', 'Μυϊκή υπερτροφία με βάρη', 5, 60, 15, 1, 5, 7520, '18/06/2026 20:00', 2),
(6, 'TRX', 'Προπόνηση με ιμάντες', 10, 45, 10, 1, 6, 7519, '15/06/2026 19:00', 9),
(7, 'Personal Training', 'Ατομικό πρόγραμμα ενδυνάμωσης', 1, 60, 30, 1, 7, 7520, '17/06/2026 11:00', 0),
(8, 'Aerobics', 'Αερόβια προπόνηση για όλους', 20, 45, 8, 1, 8, 7515, '16/06/2026 18:00', 2),
(9, 'Powerlifting', 'Ανάπτυξη μέγιστης δύναμης', 6, 90, 20, 0, 9, 7522, '18/06/2026 16:00', 12),
(10, 'Zumba', 'Χορός και γυμναστική', 25, 50, 8, 1, 10, 7515, '17/06/2026 19:30', 5);
